...
import {registerUser, getUser , getPubllicProfileUser, loginUser, getCurrentUser, updateUserProfile, deleteUser} from '../controllers/user.controller.ts'
...
router.get('/PublicProfileUser/:id', getPubllicProfileUser)
